...
Factors *sequenceTransfer(Factors *factors, LBase *lineBase) {
   ...
   * @note The result of LineBaseResult is a 1D array and a denominator, this
   * function transfer it to a 2D array
   *
   * @param factors
   * @param lineBase
   * @return Factors*
   */
  long long **factorSequence =
      (long long **)malloc(sizeof(long long *) * lineBase->order + 1);
